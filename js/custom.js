var waitIntgrtn = setInterval(function () {
    ...
    var bID = window.intgrtn.lookup("bID", true);
    ...
    window.intgrtn.events.on("get.project.details.success", function (response) {
        ...
        document.getElementById("location").innerText = response.data.client.location.country;
    ...
    window.intgrtn.getBrokers({}, function (response) {
        ...
        if (window.intgrtn.lookup("bID", true) && brokerResponse.data.items.length > 0) {
            brokerResponse.data.items.forEach(function (broker) {
                ...
                if (broker.advertiserAccountProjectHash == "BMj" && window.intgrtn.lookup("bID", true) == "BMj") { //trade360
                ...
                } else if (broker.advertiserAccountProjectHash == "6bk" && window.intgrtn.lookup("bID", true) == "6bk") { //EuropeFX
    ...
    function appendCheckbox() {
        ...
        formElements.forEach(function (element) {
            ...
            $(element).find('.intgrtn-btn-submit').append('<i class="fa fa-user-plus" aria-hidden="true"></i>').prop('disabled', false);
            $('\t\t\t\t\t\t\t<div class="checkboxes js-checkboxes-holder">\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value="" checked><span><span data-i18n>By checking this box you agree to open an account with</span> <span class="broker_name">' + brokerName + '</span></span></label>\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value="" checked><span><span data-i18n>By checking this box you agree to our</span> <span class="broker_name">' + brokerName + '</span> <a href="' + terms + '" target="_blank"><span data-i18n="">Terms</span></a>, <a href="' + privacy + '" target="_blank"><span data-i18n="">Privacy</span></a> &amp; <a href="' + gdpr + '" target="_blank"><span data-i18n="">Spam Disclaimer</span></a> </span></label>\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value="" checked><span><span data-i18n>By checking this box you approve that you read the</span> <span class="broker_name">' + brokerName + '</span> <a href="' + risk + '" target="_blank"><span data-i18n="">Risk Warning</span></a> <span data-i18n="sub-text"></span></span> </label>\n' +
    ...
    window.intgrtn.events.on('form.optin.success', function () {
        if (bID == "yel") {
            ...
            $('.gtd-form-step-2-exness').removeClass('hidden');
            $('.content').addClass('align-end');
        } else {
            $('.gtd-form-step-1').addClass('hidden');
    ...
    function appendCheckboxOptin() {
        ...
        formElements.forEach(function (element) {
            ...
            $('\t\t\t\t\t\t\t<div class="checkboxes js-checkboxes-holder">\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value=""><span><span data-i18n>By checking this box you agree to subscribe to Traders Expert & it’s affiliates brand assets newsletter</span></span></label>\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value=""><span><span data-i18n>By checking this box you agree to our</span> <a href="https://traders.expert/terms-conditions/" target="_blank" data-i18n>Terms</a>, <a href="https://traders.expert/privacy-policy/" target="_blank" data-i18n>Privacy</a><span data-i18n> & </span><a href="https://traders.expert/spam-disclaimer/" data-i18n target="_blank">Spam Disclaimer</a></span></label>\n' +
                '\t\t\t\t\t\t\t\t<label><input type="checkbox" value=""><span><span data-i18n>By checking this box you agree to our</span> <a href="https://traders.expert/privacy-policy/" target="_blank" data-i18n>GDPR</a> <span data-i18n>terms</span></span></label>\n' +
                '\t\t\t\t\t\t\t</div>').insertBefore($(element).find(".intgrtn-btn-submit-holder"));
            $(element).find('input[type="checkbox"]').change(function () {
                if ($(element).find('input[type="checkbox"]:checked').length === $(element).find('input[type="checkbox"]').length) {
                    $(element).find('.intgrtn-btn-submit').prop('disabled', false);
    ...
    function setStepInnerText() {
        $("#form-step").text( function(){
            return $('.gtd-form-step-1').hasClass('hidden') ? "2" : "1";
        });
    }
}, 10);